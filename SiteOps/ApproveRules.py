...
parser.add_argument('-a', action='store_true', default=False, dest='auto',
                    help="auto mode, automatically approve the ones that can be approved. by default, without '-a', it asks for confirmation")
parser.add_argument('-s', action='store_true', default=False, dest='silent',
                    help="silent mode, no output; without '-a', it still prompts for action")
parser.add_argument('-v', action='store_true', default=False, dest='verbose', help="verbose mode, overridden by '-s'")
parser.add_argument('-f', action='append', dest='file', default=[],
                    help="file of rules, one each line, beginning with rule id; could have multiple -f")
